  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="font-manrope font-bold text-2xl text-[#1a2820] dark:text-white">Family Profiles</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {family.map((member) => (
          <div key={member.name} className="bg-white dark:bg-[#1e2820] rounded-3xl border border-[#e0e8e2] dark:border-white/10 p-6 flex flex-col items-center text-center group hover:border-[#5E7464]/30 hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] transition-all relative overflow-hidden">
            {/* Decoration */}
            <div className="absolute top-0 right-0 w-16 h-16 bg-[#F8F8F4] dark:bg-[#141a15] rounded-bl-[40px] -translate-y-1 -translate-x-1 border-b border-l border-[#e0e8e2] dark:border-white/10 flex items-center justify-center">
            ...
            <h3 className="font-manrope font-bold text-lg text-[#1a2820] dark:text-white">{member.name}</h3>
            <p className="text-xs font-semibold text-[#9ab0a0] uppercase tracking-widest mt-1">{member.role}</p>

            <div className="w-full h-px bg-[#f0f4f1] dark:bg-white/5 my-6" />

            <div className="grid grid-cols-2 gap-4 w-full">
              <div>
                <p className="text-[10px] font-bold text-[#9ab0a0] uppercase tracking-tighter">Medicines</p>
                <p className="text-sm font-bold text-[#1a2820] dark:text-white mt-1">{member.meds}</p>
              </div>
              <div>
            ...
            <button className="w-full mt-6 py-3 rounded-2xl bg-[#F8F8F4] dark:bg-[#141a15] border border-[#e0e8e2] dark:border-white/10 text-xs font-bold text-[#52615a] dark:text-[#9ab0a0] hover:bg-[#42594A] hover:text-white hover:border-[#42594A] transition-all">
              Switch to Profile
            </button>
          </div>
        ))}
        ...
        {/* Add Card */}
        <button className="border-2 border-dashed border-[#c3d4c8] dark:border-white/20 rounded-3xl p-6 flex flex-col items-center justify-center gap-4 text-[#9ab0a0] hover:border-[#5E7464] hover:text-[#5E7464] hover:bg-[#F8F8F4] dark:hover:bg-[#141a15] transition-all">
          <div className="w-16 h-16 rounded-full bg-[#f0f5f1] dark:bg-[#1e2820] flex items-center justify-center">
      ...
      <div className="grid md:grid-cols-3 gap-6 pt-6">
        {[
          ...
          <div key={f.title} className="p-6 rounded-3xl bg-white dark:bg-[#1e2820] border border-[#e0e8e2] dark:border-white/10 flex items-start gap-4">
            ...
            <div>
              <h4 className="font-manrope font-bold text-[#1a2820] dark:text-white text-sm mb-1">{f.title}</h4>
