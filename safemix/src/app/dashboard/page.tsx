  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-manrope font-bold text-2xl text-[#1a2820]">{greeting}, {displayName} 👋</h1>
      ...
      {redAlerts.length > 0 ? (
        <div className="flex items-center gap-4 bg-red-50 border border-red-200 rounded-2xl p-4">
          ...
          <Link href="/dashboard/reports" className="text-xs font-semibold text-red-600 hover:underline whitespace-nowrap">
            View Report
          </Link>
        </div>
      ) : yellowAlerts.length > 0 ? (
        <div className="flex items-center gap-4 bg-amber-50 border border-amber-200 rounded-2xl p-4">
          ...
          <Link href="/dashboard/reports" className="text-xs font-semibold text-amber-600 hover:underline whitespace-nowrap">
            View Report
          </Link>
        </div>
        ...
        <div className="flex items-center gap-4 bg-[#f0f8f4] border border-[#c3d4c8] rounded-2xl p-4">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-[#1a2820]">No safety checks yet</p>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={s.label} className="bg-white rounded-2xl p-5 border border-[#e0e8e2] hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-shadow">
            <div className="flex items-center justify-between mb-4">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: s.iconBg }}>
                <s.icon className="w-5 h-5" style={{ color: s.color }} />
              </div>
            </div>
            <p className="text-2xl font-manrope font-bold text-[#1a2820]">{s.value}</p>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        {/* Current Medicines */}
        <div className="bg-white rounded-2xl border border-[#e0e8e2] overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#f0f4f1]">
            <h2 className="font-manrope font-semibold text-[#1a2820]">Current Medicines</h2>
          ...
          <div className="divide-y divide-[#f0f4f1]">
            {medicines.map((m) => (
              <div key={m.name} className="flex items-center gap-4 px-6 py-4 hover:bg-[#f8faf8] transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-[#1a2820] truncate">{m.name}</p>
        ...
        <div className="bg-white rounded-2xl border border-[#e0e8e2] overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#f0f4f1]">
            <div className="flex items-center gap-2">
              <h2 className="font-manrope font-semibold text-[#1a2820]">AI Interactions</h2>
              {allVerdicts.length > 0 && (
          ...
          <div className="divide-y divide-[#f0f4f1]">
            {allVerdicts.length === 0 ? (
              <div className="px-6 py-10 text-center">
                ...
                <p className="text-sm font-medium text-[#1a2820] mb-1">No AI checks yet</p>
              ...
              allVerdicts.slice(0, 4).map((v) => {
                ...
                return (
                  <div key={v.id} className="flex items-center gap-4 px-6 py-4 hover:bg-[#f8faf8] transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-[#1a2820] truncate">{v.medicines.join(" + ")}</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <Link key={a.label} href={a.href}
            className="flex items-center gap-3 bg-white rounded-2xl p-4 border border-[#e0e8e2] hover:border-[#5E7464]/30 hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all group"
          >
            ...
            <span className="text-sm font-medium text-[#1a2820] leading-snug">{a.label}</span>
